...
<div class="row">
    <div class="col-xs-12">
        ...
        ">
            ...
            <div class="box-body">
                @if ($version->isLatestPanel())
                    You are running Pterodactyl Panel version <code>{{ config('app.version') }}</code>. Your panel is up-to-date! || You are using MineCube Theme Custom Edited Edition By MBG Version <code>2.0</code>
                @else
